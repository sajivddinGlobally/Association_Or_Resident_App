...
GetPropertyUnitDetailsModel getPropertyUnitDetailsModelFromJson(String str) => GetPropertyUnitDetailsModel.fromJson(json.decode(str));

String getPropertyUnitDetailsModelToJson(GetPropertyUnitDetailsModel data) => json.encode(data.toJson());
...
class GetPropertyUnitDetailsModel {
    ...
    factory GetPropertyUnitDetailsModel.fromJson(Map<String, dynamic> json) => GetPropertyUnitDetailsModel(
        status: json["status"],
...
class Data {
    ...
    factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        propertyInformation: json["property_information"] == null ? [] : List<PropertyInformation>.from(json["property_information"]!.map((x) => PropertyInformation.fromJson(x))),
        assignedPropertyOwner: json["assigned_property_owner"] == null ? null : AssignedPropertyOwner.fromJson(json["assigned_property_owner"]),
        recentPropertyActivity: json["recent_property_activity"] == null ? [] : List<RecentPropertyActivity>.from(json["recent_property_activity"]!.map((x) => RecentPropertyActivity.fromJson(x))),
        propertyRecords: json["property_records"] == null ? [] : List<PropertyRecord>.from(json["property_records"]!.map((x) => PropertyRecord.fromJson(x))),
    );
    ...
    Map<String, dynamic> toJson() => {
        ...
        "property_information": propertyInformation == null ? [] : List<dynamic>.from(propertyInformation!.map((x) => x.toJson())),
        "assigned_property_owner": assignedPropertyOwner?.toJson(),
        "recent_property_activity": recentPropertyActivity == null ? [] : List<dynamic>.from(recentPropertyActivity!.map((x) => x.toJson())),
        "property_records": propertyRecords == null ? [] : List<dynamic>.from(propertyRecords!.map((x) => x.toJson())),
    };
}
...
class AssignedPropertyOwner {
    ...
    factory AssignedPropertyOwner.fromJson(Map<String, dynamic> json) => AssignedPropertyOwner(
        name: json["name"]?.toString(),
        avatar: json["avatar"]?.toString(),
        tag: json["tag"]?.toString(),
        roleLabel: json["role_label"]?.toString(),
        isVerified: json["is_verified"] == true || json["is_verified"] == 1 || json["is_verified"]?.toString() == "true",
...
class RecentPropertyActivity {
    ...
    factory RecentPropertyActivity.fromJson(Map<String, dynamic> json) => RecentPropertyActivity(
...
class StatsCards {
    ...
    factory StatsCards.fromJson(Map<String, dynamic> json) => StatsCards(
        unitNumber: json["unit_number"] == null ? null : PropertyType.fromJson(json["unit_number"]),
        propertyType: json["property_type"] == null ? null : PropertyType.fromJson(json["property_type"]),
        propertyScore: json["property_score"] == null ? null : PropertyScore.fromJson(json["property_score"]),
    );
